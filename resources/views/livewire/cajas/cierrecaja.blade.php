                ...
                <div class="m-4 p-4">
                    ...
                    <table>
                        <tbody>
                            ...
                            <br>
                            <tr>
                                <td class="text-right"><h3>{{$efectivo_actual>$saldoAcumulado ? 'Efectivo Sobrante:':'Efectivo Faltante: '}} </h3></td>
                            ...
                            <tr>
                                <td>  <h3 class="text-right">Monto limite Efectivo:</h3></td>
                                <td> <h3 class="text-right">{{$monto_limite}}</h3> </td>
