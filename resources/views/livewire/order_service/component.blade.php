    ...
    <div class="row">
        <div class="col-12">
            <div class="d-lg-flex my-auto p-0 mb-3">
                <div>
                    <h5 class=" text-white" style="font-size: 16px">ORDENES DE SERVICIO</h5>
                </div>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-th text-withe text-center">FECHA RECEPCION</th>
                                        <th class="table-th text-withe text-center">FECHA ESTIMADA ENTREGA</th>
                                        <th class="table-th text-withe text-center">RESPONSABLE TECNICO</th>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.livewire.on('responsable-tecnico', event => {
                swal(
                    ...
                    'Fuiste Asignado a la Orden de Servicio "' + @this.id_orden_de_servicio +
                    '" exitósamente',
                    'success'
                )
            });
            ...
            window.livewire.on('orden-eliminado', event => {
                swal(
                    ...
                    'La Orden de Servicio: "' + @this.id_orden_de_servicio +
            ...
            window.livewire.on('Serviciopendienteocupado', event => {
                swal("El Servicio ya cuenta con un Responsable Técnico",
                    "Perdon pero el Servicio ya fué asignado a: " + @this.alert_responsabletecnico, {
                        icon: "info",
                        buttons: {
                            confirm: {
                                className: 'btn btn-info'
            ...
            window.livewire.on('acceso-denegado', event => {
                swal("¡No puede realizar esta acción!",
                    "No puede Editar o Terminar este Servicio por que no es el Técnico Responsble de este", {
                        icon: "info",
                        buttons: {
                            confirm: {
                                className: 'btn btn-info'
