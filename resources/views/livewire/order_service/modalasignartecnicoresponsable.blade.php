<div wire:ignore.self class="modal fade" id="asignartecnicoresponsable" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    ...
                    {{ ucwords(strtolower($this->detalleservicio)) }} |
                        ...
                        <tbody>
                            @foreach ($this->lista_de_usuarios as $lu)
                                <tr class="tablaserviciostr">
                                    ...
                                    <td>
                                        <span wire:click.prevente="asignartecnico({{ $lu->idusuario }})"
                                            title="Elegir Técnico Responsable" class="stamp stamp nombresestilosmodal">
                                            {{ $lu->nombreusuario }}
                                        </span>
                                    </td>
                                    <td class="text-center">
