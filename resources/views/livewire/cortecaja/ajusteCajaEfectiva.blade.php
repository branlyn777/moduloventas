    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="row justify-content-center table-3">
                <div class="mb-2" style="border:3px solid rgba(7, 158, 228, 0.404);border-radius: 20px; margin-top: 2rem;">
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            ...
                            <h3
                                style="margin-top: -15px; background-color: rgb(255, 255, 255); width: 128px; margin-top: -39px; margin-left: 133px; margin-right:80px">
                                <b> Arqueo de Caja</b>
                            </h3>
                            @else
                            <h3 style="margin-top: -15px; background-color: rgb(255, 255, 255); width: 154px; margin-top: -39px; margin-left: 105px; margin-right:75px">
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h3 class="text-right">{{number_format($saldoAcumulado-$monto_limite,2)}}</h3>
                                    </td>
            ...
            <div class="row justify-content-center">
                ...
                <button type="button" class="boton-azul p-2 mb-3" wire:click='finArqueo()'>Finalizar Arqueo de
                    Caja</button>
                @else

                <button type="button" class="boton-verde p-2 mb-3 mr-4" wire:click='finalizarCierre()'>Finalizar
                    Cierre</button>
                @endif
