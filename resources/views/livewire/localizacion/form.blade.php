                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            @error('codigo') <span class="text-danger er" style="font-size: 13px">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            @error('descripcion') 
                            <span class="text-danger er" style="font-size: 13px">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8">
                        <div class="form-group">
                            ...
                            @error('destino') <span class="text-danger er" style="font-size: 13px">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
