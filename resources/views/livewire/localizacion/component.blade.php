    ...
    <div class="row">
        <div class="col-12">
            <div class="card-header pb-0">
                <div class="d-lg-flex">
                    <div>
                        <h5 class="mb-0 text-white" style="font-size: 16px">Mobiliarios</h5>
                    </div>

                    <div class="ms-auto my-auto mt-lg-0 mt-4">
                        <div class="ms-auto my-auto">
                        <a href="javascript:void(0)" class="btn btn-add btn-sm mb-0" wire:click='resetUI()' data-bs-toggle="modal" wire:click="$set('selected_id', 0)"
                            data-bs-target="#theModal"><i class="fas fa-plus me-2"></i> Nuevo Mobiliario</a>
                        </div>
                    </div>
                </div>
            </div>
