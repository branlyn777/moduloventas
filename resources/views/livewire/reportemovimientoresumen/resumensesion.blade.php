    ...
    <div class="col-12">
        ...
        <div class="card mb-4 px-2">
            <div class="card-header mt-4" style="background-color: rgb(255, 255, 255)">
                <h5 class="mb-3 text-dark text-center mt-1" style="font-size: 20px"><b>INFORME DE SESION DE CAJA</h5>
            </div>
            ...
            <div class="card-body px-12 pt-3 mt-4 mb-6" style="background-color: rgb(255, 255, 255)">
                ...
                <div class="d-flex bd-highlight mb-1">
                    ...
                    <div class="p-2 bd-highlight">
                        ...
                        <a class="btn btn-primary rounded-circle btn-sm btn-xs px-2 py-1 collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#tablaventas" aria-expanded="false"
                ...
                <div class="d-flex bd-highlight mb-3">
                    <div class="me-auto p-2 bd-highlight">
                        <h6 class="text-lg">Otros Ingresos Cobrados durante la Sesion: </h6>
                    </div>

                    <div class="p-2 bd-highlight"><span class="me-3">
                            <b>{{ number_format($totalesIngresosIE->sum('importe'), 2) }}</span>
                        <a class="btn btn-primary rounded-circle btn-sm btn-xs px-2 py-1 collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#tablaotrosingresos" aria-expanded="false"
                            aria-controls="tablaotrosingresos">
                            <i class="fas fa-chevron-down collapse-icon collapsed"></i>
                ...
                <div class="d-flex bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight"><span class="me-3">
                        ...
                        <a class="btn btn-primary rounded-circle btn-sm btn-xs px-2 py-1 collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#tablaegresos" aria-expanded="false"
                            aria-controls="tablaegresos">
                            <i class="fas fa-chevron-down collapse-icon collapsed"></i>
                ...
                <div class="d-flex bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight"><span class="me-5">
                            <b>{{ number_format($sobrante, 2) }}</span>
                    </div>
                </div>
                <div class="d-flex bd-highlight mb-3">
                    <div class="me-auto p-2 bd-highlight">
                    ...
                    <div class="p-2 bd-highlight"><span class="me-5">
                            <b>{{ number_format($faltante, 2) }}</span>
                    </div>
                </div>
                <div class="d-flex bd-highlight mb-3">
                    <div class="me-auto p-2 bd-highlight">
                    ...
                    <div class="p-2 bd-highlight"><span class="me-5">
                            <b>{{ number_format($recaudo, 2) }}</span>
                    </div>
                </div>
                ...
                <div class="d-flex bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight"><span class="me-5">
                            <b>{{ number_format($totalsesion, 2) }}</span></div>
                </div>
