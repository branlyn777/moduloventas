                ...
                <table class="table main">
                  ...
                  <tbody>
                    ...
                    <tr data-bs-toggle="collapse" data-bs-target="#ingresos-detalle-servicios" class="accordion-toggle">
                      ...
                      <td class="w-5 text-center">{{ number_format($totalServicios->sum('importe'), 2) }}</td>
                      <td class="text-end"><button class="btn btn-primary"><i class="fa fa-chevron-down"></i></button></td>
                    </tr>
                    <tr>
                      <td colspan="3" class="hiddenRow">
                                                                           ...
                                                                           <div class="accordion-item mb-3">
                                                                               <h6 class="accordion-header"
                                                                                   ...
                                                                                   <button
                                                                                       ...
                                                                                       <div class="text-sm">
                                                                                           COD.{{ $p->order_id }},{{ $p->ctipo == 'efectivo' ? 'Cobro realizado en efectivo' : 'Cobro realizado por transaccion de ' }}
                                                                                       </div>
                                                                                       <i class="collapse-close fa fa-plus text-xs pt-1 position-absolute end-0 me-3"
                                                                                           aria-hidden="true"></i>
                                                                                       <i class="collapse-open fa fa-minus text-xs pt-1 position-absolute end-0 me-3"
