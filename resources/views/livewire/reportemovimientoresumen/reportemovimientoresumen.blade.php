    ...
    <div class="card">
        <div class="accordion" id="accordionExample">
            ...
            <h2 class="accordion-header" id="headingTwo">
                <button class="accordion-button collapsed" style="wi" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoventa" aria-expanded="false" aria-controls="collapseTwoventa">
                
                    {{-- <div class="d-flex justify-content-between bd-highlight mb-3">
                        <div class="">
                            <p><b>Ventas Total</b></p>
                        </div>
                        <div>
                            <p><b>Bs:{{number_format($totalesIngresosV->sum('importe'),2) }}</b></p>
                        </div>
                    </div> --}}
            ...
            <div id="collapseTwoventa" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
...
>>>>>>> 0a8e027374623ca0b6b33b1ed3de28d9e9c491d5
                                                                                    <tr>
                                                                                        <td>
...
<<<<<<< HEAD
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoasd" aria-expanded="false" aria-controls="collapseTwoasd">
                    <p><b>Egresos</b></p>
                    </button>
                </h2>
                <div id="collapseTwoasd" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
