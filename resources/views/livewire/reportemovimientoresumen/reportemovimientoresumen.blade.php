                    ...
                    <table class="table main">
                        ...
                        <tbody>
                            <tr data-bs-toggle="collapse" data-bs-target="#ingresos-detalle-ventas"
                                ...
                                <td class="w-5 text-center">{{ number_format($totalesIngresosV->sum('importe'), 2) }}
                                </td>
                            ...
                            <tr data-bs-toggle="collapse" data-bs-target="#ingresos-detalle-servicios"
                                ...
                                <td class="w-5 text-center">{{ number_format($totalServicios->sum('importe'), 2) }}
                                </td>
                                <td class="text-end"><button class="btn btn-primary"><i
                                            class="fa fa-chevron-down"></i></button></td>
                            </tr>
                            ...
                            <tr data-bs-toggle="collapse" data-bs-target="#otros-ingresos" class="accordion-toggle">
                                ...
                                <td class="w-5 text-center">{{ number_format($totalesIngresosIE->sum('importe'), 2) }}
                                </td>
                                <td class="text-end"><button class="btn btn-primary"><i
                                            class="fa fa-chevron-down"></i></button></td>
                            </tr>
                            ...
                            <tr data-bs-toggle="collapse" data-bs-target="#egresos-detalle" class="accordion-toggle">
                                ...
                                <td class="w-5 text-center">{{ number_format($totalesEgresosIE->sum('importe'), 2) }}
                                </td>
                                <td class="text-end"><button class="btn btn-primary"><i
                                            class="fa fa-chevron-down"></i></button></td>
                            </tr>
