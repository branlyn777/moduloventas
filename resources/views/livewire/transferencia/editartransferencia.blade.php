    ...
    <div class="row">
        <div class="col-12">
            <div class="d-lg-flex my-auto p-0 mb-4">
                <div>
                    <h5 class=" text-white" style="font-size: 16px">Editar Transferencia Productos</h5>
                    <h5 class=" text-white" style="font-size: 16px">N° de Transferencia: {{ $ide }}</h5>
                </div>
            </div>
                    ...
                    <div class="padding-left: 12px; padding-right: 12px;">
                        ...
                        <div class="row justify-content-between">
                            <div class="mt-lg-0 col-md-3">
                                <label style="font-size: 1rem">Origen de transferencia:</strong> </label>
                            ...
                            <div class="mt-lg-0 col-md-3">
                                <label style="font-size: 1rem">Destino de transferencia:</strong> </label>
                            ...
                            <div class="mt-lg-0 col-md-3">
                                <label style="font-size: 1rem"> Observacion:</strong> </label>
