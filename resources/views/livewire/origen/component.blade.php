@section('migaspan')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0 text-white">Origen</h6>
    </nav>
@endsection
                ...
                <div class="ms-auto my-auto mt-lg-1">
                    <div class="ms-auto my-auto">
                        <a class="btn btn-add mb-0" wire:click="Agregar()">
                            <i class="fas fa-plus"></i> Agregar Origen</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="mt-lg-0 col-md-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input type="text" wire:model="search" placeholder="Origen"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tr class="text-left" style="font-size: 14px">
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:void(0)" wire:click="Edit({{ $item->id }})"
                                                class="mx-3" class="boton-azul" title="Editar Origen">
                                                <i class="fas fa-edit" style="font-size: 14px"></i>
                                            </a>
                                            
                                            <a href="javascript:void(0)"
                                                onclick="Confirm('{{ $item->id }}','{{ $item->nombre }}', '{{ $item->relacionados->count() }}')"
                                                class="boton-rojo mx-3" title="Eliminar Origen">
