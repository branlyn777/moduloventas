    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- <li class=@yield('nivelinventariosli', 'nav-item ')>
                <a class=@yield('nivelinventariosnav', 'nav-link ') href="{{ url('ingresoegreso') }}">
                    <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                ...
                <div class=@yield('Reportesshow', 'collapse ') id="componentsExamples4">
                    ...
                    <ul class="nav ms-4">
                        <li class=@yield('ventamesventasli', 'nav-item ')>
                            <a class=@yield('ventamesventasnav', 'nav-link ') href="{{ url('reportemes') }}">
                                <span class="sidenav-mini-icon"> R </span>
