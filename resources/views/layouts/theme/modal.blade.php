                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-5 col-md-4">
                        <div class="form-group row">
                            ...
                            <input type="text" wire:model.lazy="codigo" class="form-control col-lg-8"
                                placeholder="ej: 20202225">
                            <button type="button" wire:click="GenerateCode()" class="btn btn-info m-0 p-l-0 p-r-0"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group-prepend mb-3">
                                ...
                                <a href="javascript:void(0)" class="btn btn-dark pl-2 pr-2" data-toggle="modal"
                                    title="Agregar Unidad" data-target="#modalUnidad"> <i
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group-prepend mb-3">
                                ...
                                <a href="javascript:void(0)" class="btn btn-dark pl-2 pr-2" data-toggle="modal"
                                    title="Agregar Marca" data-target="#modalMarca"> <i
