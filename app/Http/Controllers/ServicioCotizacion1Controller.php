...
class ServicioCotizacion1Controller extends Controller
{
    public function print($idservicio)
    {
        ...
        $pdf = PDF::loadView('livewire.pdf.serviciocotizacion1', compact('datos_servicio','telefono','detalles_extra', 'direccionempresa' ,'year','logoempresa','nombreempresa' , 'codigo','fecharecepcion','responsable_tecnico','dia_mes_actual'));
